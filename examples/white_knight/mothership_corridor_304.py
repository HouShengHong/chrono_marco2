...
r_list = [right_big_jump, right_mid_jump, right_down_mid_jump, right_down_prev_jump, right_fire_rush]
l_list = [left_big_jump, left_mid_jump, left_down_mid_jump, left_down_prev_jump, left_fire_rush]

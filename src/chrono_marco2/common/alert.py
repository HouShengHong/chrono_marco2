...
def red_alert_monitor(eye: Eye) -> AlertMonitor:
    ...
    def on_red_alert():
        print("Red alert!")
        notify_user_screenshot_external_trigger(MyTelegramSetting.chat_id, "Red alert!")

    return AlertMonitor(check_red_alert, on_red_alert,check_args=(eye,), name="Red_Alert_Monitor")
...
def different_map_alert_monitor(eye: Eye) -> AlertMonitor:
    ...
    def on_different_map_alert():
        ...
        notify_user_screenshot_external_trigger(MyTelegramSetting.chat_id, "Different map alert!")

    return AlertMonitor(check_different_map_alert, on_different_map_alert,check_args=(eye,), name="Different_Map_Alert_Monitor")